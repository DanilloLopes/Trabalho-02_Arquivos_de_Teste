programa
{
	...
	{	
		real salario_bruto =0.0, horas_trabalhadas_mes, valor_por_hora, horas_extras_trabalhdas, periculosidade
		caracter s_ou_n_eletricitario
		
		escreva("              SIMULADOR DE ADICIONAL PERICULOSIDADE")
	 	escreva("\n\n")
	 	escreva("-------------------------------------------------------------\n\n")
	 	escreva("Insira o valor do salario bruto para calcular o adicional por periculosidade: ")
	 	leia(salario_bruto)
	 	escreva("\n\n")
	 	escreva("Insira a quantidade de horas trabalhadas no mês: ")
	 	leia(horas_trabalhadas_mes)
	 	escreva("\n\n")
	 	escreva("Insira a quantidade de horas extras trabalhadas no mes: ")
	 	leia(horas_extras_trabalhdas)
	 	escreva("\n\n")
	 	escreva("Voce é eletricitário ? (s) ou (n)")
	 	leia(s_ou_n_eletricitario)
	 	escreva("\n\n")
	 	
	 	periculosidade = equacao_periculosidade(salario_bruto,horas_trabalhadas_mes, horas_extras_trabalhdas,  s_ou_n_eletricitario)
	...
	funcao real equacao_periculosidade(real salario_bruto, real horas_trabalhadas_mes,real horas_extras_trabalhdas, caracter s_ou_n_eletricitario)
	{	
		...
		senao se(s_ou_n_eletricitario == 'n')
		{		
			valor_por_hora = salario_bruto/horas_trabalhadas_mes
 ...
 * 
 * @POSICAO-CURSOR = 250; 
 * @DOBRAMENTO-CODIGO = [10, 24, 51, 95, 165, 199, 239, 285, 320, 360, 389, 395, 402, 494, 545, 552, 664, 671, 728, 734, 741, 846, 853, 894, 922, 954, 964, 995];
 * @PONTOS-DE-PARADA = ;
