programa
{
	...
	{	
		...
		valor_para_verificar = recebe_salario_bruto(numero_ou_nao, valor_para_verificar)
		...
		cadeia sim_ou_nao = testador_sim_ou_nao(PERGUNTA_QUE_A_FUNCAO_VAI_FAZER)
		real periculosidade
		escreva("\n\n")
	...
	funcao cadeia recebe_salario_bruto(logico numero_ou_nao, cadeia valor_para_verificar)
	{
		enquanto(numero_ou_nao == falso)
		{
	...
	funcao cadeia testador_sim_ou_nao(cadeia pergunta_que_a_funcao_vai_fazer)
	{
		cadeia sim_ou_nao = ""
